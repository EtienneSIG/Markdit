...
const STRINGS: Record<Locale, Dict> = {
  en: {
    ...
    'slides.title': 'Generate slides',
    'slides.preview': 'Slide deck (Markdown)',
    'slides.count': '{n} slide(s) generated. Slides are separated by a --- break (Marp / reveal.js compatible).',
    'slides.copy': 'Copy',
    'slides.copyFormatted': 'Copy formatted',
  ...
  fr: {
    ...
    'slides.title': 'Générer des diapositives',
    'slides.preview': 'Présentation (Markdown)',
    'slides.count':
      '{n} diapositive(s) générée(s). Les diapositives sont séparées par une coupure --- (compatible Marp / reveal.js).',
    'slides.copy': 'Copier',
    'slides.copyFormatted': 'Copier (formaté)',
    'slides.copied': 'Copié dans le presse-papiers.',
    'slides.download': 'Télécharger .md',
    'slides.save': 'Enregistrer sous…',
